                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="">Direction</a></li>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Direction</h1>
...
<script>
	var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	    mapOption = { 
	        center: new kakao.maps.LatLng(37.476407, 126.879851), // 지도의 중심좌표
	        level: 4 // 지도의 확대 레벨
	    };
	...
	var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	    markerPosition = new kakao.maps.LatLng(37.476407, 126.879851); // 마커가 표시될 위치입니다
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                ...
                <p><span class="d-block">Email:</span> <span> info@GDCC.com</span></p>
              </div>
            </div>
          </div>
        </div>
