...
<%
	...
	System.out.println(rsvNo + "<-- rsvNo updateHotelReviewForm.jsp param");
...
<section>
	<div class="container">
	<form method="post" action="/Semi_F_GDCC/customer/GDCC/updateHotelReviewAction.jsp">
		<table>
		<h1>UPDATE HOTEL REVIEW</h1>
			<tr>
				<th style="width:10%">RSV NO.</th>
				<td><input style="width:5%" type="text" value="<%=rsvNo%>" name="rsvNo" readonly="readonly"></td>
			</tr>
			<tr>
				<th style="width:10%">평점</td>
