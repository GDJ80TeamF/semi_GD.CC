...
<%
	...
	if(row == 1){
		...
		response.sendRedirect("/Semi_F_GDCC/customer/GDCC/QnAList.jsp"); //성공시 QnA게시판으로
	} else {
		System.out.println("입력실패");
		response.sendRedirect("/Semi_F_GDCC/customer/GDCC/insertQnAForm.jsp"); //실패시 다시 입력 페이지로			
	}
