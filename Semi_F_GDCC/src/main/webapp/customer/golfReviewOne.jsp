...
<div>
	<h1>golfReview 상세보기</h1>
		<table border="1">
			...
			<a href="/Semi_F_GDCC/customer/updateGolfReviewForm.jsp?reviewNo=<%=reviewNo%>">리뷰 수정</a>
			<br>
			<a href="/Semi_F_GDCC/customer/action/deleteGolfReviewAction.jsp?reviewNo=<%=reviewNo%>">리뷰 삭제</a>
		</table>
</div>
