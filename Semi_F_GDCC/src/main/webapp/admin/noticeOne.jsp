...
<h1>공지 상세정보</h1>
	...
	<a href="/Semi_F_GDCC/admin/updateNoticeForm.jsp?noticeNo=<%=noticeNo%>" class="btnn">공지 수정하기</a>
	<a href="/Semi_F_GDCC/admin/deleteNoticeForm.jsp?noticeNo=<%=(Integer)(m.get("noticeNo"))%>" class="btnn">공지 삭제하기</a>
